    ...
    with open("C:/Users/Unnati/Documents/NLP/Project/data/Holmes.machine_format.questions.txt", "r") as file:
        ...
        for line in file:
            ...
            if targetWordIndex - 3 > 0  and not words[targetWordIndex].isdigit() and words[targetWordIndex] is not ',':
                fourgram  = words[targetWordIndex-3] + " "+ words[targetWordIndex-2] + " " + words[targetWordIndex-1] + " "+ words[targetWordIndex]
                ...
                if fourgram in myFourGramDict:
                    if trigram not in myTrigramDict:
                        if bigram not in myBigramDict:
                            ...
                            trigramProb = float(int(myFourGramDict[fourgram][0])/int(myBigramDict[bigram]))
                    else:
                        trigramProb = float(int(myFourGramDict[fourgram][0])/int(myTrigramDict[trigram][0]))
                    ...
                    if trigram not in myTrigramDict:
                        if bigram not in myBigramDict:
                            ...
                            trigramProb = 1.0 / int(myBigramDict[bigram])
                    else:
                        trigramProb = 1.0/int(myTrigramDict[trigram][0])
